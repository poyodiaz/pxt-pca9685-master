NOT MINE !!! JUST A COPY FROM ANOTHER REPOSITORY , BUT I FOUND OUT THIS MAYBE USEFULL FOR SOMEONE ELSE : IF YOU USE WITH ADAFRUIT CIRCUIT PLAYGROUND  YOU NEED "SERIAL" EXTENSION TO MAKE IT WORK
